...
Chapter 2 adds six question-led sections, eighteen six-second moments, independent exploration controls, source notes, and seven proposed concepts. Its six animation entries use the same renderer as the lesson. See [the experiment notes](../experiment/money-hierarchy/README.md). The supplied lecture compilation has no available transcript; the installed source notes disclose this.
