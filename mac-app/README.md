...
A personal offline collection for the existing Part 1, Part 2, and accepted Part 3 visualizations. SwiftUI supplies the collection and learning controls; WebKit displays independent copies of the existing HTML lessons. No server, account, API key, or network is needed to study.
...
- **My visualizations** contains preserved editions of Parts 1–3. Open a lesson and use its original controls; **Learning notes** can be hidden for more room.
...
- **Animation library** contains A01–A06. Edit descriptions/tags and reuse choices; **View animations** opens their bundled demonstrations. A04–A06 point to the connected Part 3 examples. Pattern edits do not rewrite lessons.
...
- `history.json`: understanding marks, approved concept lists, visits, library descriptions/tags and reuse choices.
