...
STYLE = '''html,body{margin:0;background:#11151e;color:#e9e7ef;font:14px system-ui;height:100%;overflow:hidden}body{display:flex;flex-direction:column;padding:12px;box-sizing:border-box}#stage{flex:1;min-height:0;position:relative;display:flex;align-items:center;justify-content:center}#svg{width:100%;height:100%;max-height:310px}#scene{width:100%}#ig-wink{display:none}footer{display:flex;align-items:center;gap:12px;padding-top:12px;width:100%;max-width:none;margin:0;border:0}button{font:inherit;border:1px solid #514a65;border-radius:7px;background:#272335;color:#eee;padding:6px 12px;cursor:pointer}#position{flex:1;min-width:0;width:auto;max-width:none;accent-color:#b8a2fa}#phase{font-size:12px;color:#aaa4bb;margin:4px 0;min-height:16px}.door,.door-g{pointer-events:none}.candidate-strip{grid-template-columns:repeat(8,1fr)}.candidate{min-width:0}.bar-fill{transition:none}'''
PLAYER = '''
